...
export default function Annonce() {
  ...
  const handleSave = async () => {
    ...
    if (
      ...
      newErrors.echange_souhaite_texte =
    ...
    try {
      ...
      if (err.response) {
        alert(
          `Erreur serveur : ${err.response.data.message || err.response.statusText}`,
        );
      } else {
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-gray-100 border border-gray-200 rounded-xl p-6 mt-4">
          ...
          <p className="text-gray-700">
            Publiée le {formatDateTime(annonce.date_publication)}
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <label className="block font-semibold text-gray-700 mb-1">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        setFormData({
                          ...formData,
                          echange_souhaite_texte: e.target.value,
                        });
                        if (errors.echange_souhaite_texte) {
                          setErrors({
                            ...errors,
                            echange_souhaite_texte: null,
                          });
                        }
                      }}
            ...
            <div className="bg-white rounded-xl p-6 lg:mt-8">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-700">
                  Membre depuis le{" "}
                  {formatDateTime(annonce?.user?.date_inscription)}
                </p>
                <p className="text-gray-700">
                  Dernière connexion le{" "}
                  {formatDateTime(annonce?.user?.derniere_connexion)}
                </p>
              </div>
