        ...
        <div className="flex justify-center items-center min-h-screen pt-12">
            <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                        <label className="block font-semibold text-gray-700 mb-1">Nom de l'annonce</label>
                        <input
                            type="text"
                            name="titre"
                    ...
                    {/* Zone de photos */}
                    <div>
                        <label className="block font-semibold text-gray-700 mb-2">Photos ({uploadedPhotos.length}/5)</label>
                    ...
                    <div>
                        <label className="block font-semibold text-gray-700 mb-1">Échanges possibles</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="block font-semibold text-gray-700 mb-1">État</label>
                        <select
                            name="etat"
                            value={formData.etat}
                            onChange={handleChange}
